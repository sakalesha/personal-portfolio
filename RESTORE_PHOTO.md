# How to Restore Project Photo

When you have a profile photo and want to go back to the 2-column layout (Text on left, Photo on right), follow these steps:

1.  Open `c:\Users\ronad\OneDrive\Desktop\Portfolio\components\Hero.tsx`
2.  Replace the entire file content with the code below.
3.  Change the image URL (`https://picsum.photos/...`) to your actual photo path (e.g., `/profile.jpg`).
